%==========================================================================
% Estimation of receiver bias for an arbitrary frequency pair.
% Same Ma & Maruyama (2003) minimum-spread search as rcv_bias_ma.m,
% but f1/f2 are parameters (Galileo E1/E5a, BeiDou B1I/B2I, ...).
%==========================================================================
function rcv_bias_ns = rcv_bias_sys(sp,ep,step,STEC_removesatbias,slant_factor,f1,f2)
% Output:
